...
.PHONY: crd-dependencies
crd-dependencies:
	hack/pull_crd_manifests.sh
.PHONY: generate
generate: controller-gen crd-dependencies ## Generate code containing DeepCopy, DeepCopyInto, and DeepCopyObject method implementations.
